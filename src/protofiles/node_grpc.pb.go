...
type NodeServiceClient interface {
	...
	BPUpdate(ctx context.Context, in *BPUpdateRequest, opts ...grpc.CallOption) (*BPResponseRequest, error)
}
...
func (c *nodeServiceClient) BPUpdate(ctx context.Context, in *BPUpdateRequest, opts ...grpc.CallOption) (*BPResponseRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BPResponseRequest)
...
type NodeServiceServer interface {
	...
	BPUpdate(context.Context, *BPUpdateRequest) (*BPResponseRequest, error)
...
func (UnimplementedNodeServiceServer) BPUpdate(context.Context, *BPUpdateRequest) (*BPResponseRequest, error) {
